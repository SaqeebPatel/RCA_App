        ...
        uploadPdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (title.isEmpty()){
                    ...
                    Toast.makeText(AddPdfActivity.this, "Please Upload PDf", Toast.LENGTH_SHORT).show();
                } else {
                    uploadPdf();
                }
    ...
    private void uploadPdf() {
        ...
        reference.putFile(pdfData)
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(AddPdfActivity.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQ && resultCode == RESULT_OK){
            ...
            if (pdfData.toString().startsWith("content://")){
                ...
                try {
                    Cursor cursor = null;
                    cursor = AddPdfActivity.this.getContentResolver().query(pdfData,null,null,null,null);
